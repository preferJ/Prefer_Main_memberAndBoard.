    ...
    <main class="form-signin w-100 m-auto">
        <form style="color: #6c757d" action="/member/loginReq" method="post">
            ...
            <div class="form-floating">
                <input type="text" name="memberId" class="form-control" id="memberId"  placeholder="memberId" value="${memberId}">
            ...
            <br>
            <div class="form-floating">
                <input type="password" name="memberPassword"  class="form-control" id="memberPassword" placeholder="memberPassword">
